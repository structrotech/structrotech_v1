...
export const FALLBACK_POSTS = [
  {
    ...
    author: {
      name: "StructroLearn Staff",
      slug: { current: "staff" },
      avatar: null,
      bio: "Educational guide writers at StructroLearn.",
    },
  },
  {
    _id: "post-2",
  ...
  },
  {
    ...
    slug: { current: "essential-cybersecurity-practices" },
    coverImage: null,
    excerpt: "Fundamental security rules every developer and administrator should follow daily.",
  ...
  {
    _id: "post-4",
    title: "Cloud Infrastructure Architecture 101",
    slug: { current: "cloud-infrastructure-101" },
    coverImage: null,
    excerpt: "A beginner-friendly tour of modern cloud architecture patterns and scalable infrastructure.",
